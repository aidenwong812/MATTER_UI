  ...
  return (
    ...
    >
      <div
        ...
        bg-[url('/images/ContactUs/d_bg.png')]
        bg-cover
        bg-no-repeat
        bg-center
        flex justify-center"
      >
        {isMobile ? (
          <>
            <Media
              type="image"
              link="/images/ContactUs/top_dot_bg.png"
              blurLink="/images/ContactUs/top_dot_bg.png"
              containerClasses="w-[110px] h-[97px]
                    !absolute left-[0px] top-[-70px]"
            />
            <Media
              type="image"
              link="/images/ContactUs/bottom_dot_bg.png"
              blurLink="/images/ContactUs/bottom_dot_bg.png"
          ...
          <div className="absolute right-0 top-[5px]">
            <Media
              type="image"
              link="/images/ContactUs/d_top_dot.png"
              blurLink="/images/ContactUs/d_top_dot.png"
